...
/*
 * Setup for Open Home Security STM32F767-2.0.4 board.
 */

/*
 * Board identifier.
 */
#define BOARD_OHS_F767
#define BOARD_NAME                  "Open Home Security STM32F767-2.0.4"
 ...
 * PD14 - GSM_PWRKEY                (input floating).
...
#define VAL_GPIOD_MODER             (PIN_MODE_OUTPUT(GPIOD_SPI3_CS) |       \
                                     ...
                                     PIN_MODE_INPUT(GPIOD_GSM_PWRKEY) |     \
...
#define VAL_GPIOD_OSPEEDR           (PIN_OSPEED_HIGH(GPIOD_SPI3_CS) |       \
                                     ...
                                     PIN_OSPEED_VERYLOW(GPIOD_AC_OFF) |     \
